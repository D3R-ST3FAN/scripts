...
// the fan.
// Includes debounce and configurable repeated transmission
...
// to prevent relay/switch bounce triggering multiple events
...
// -----------------------------------------------------
// Send an event to the slave via HTTP
// -----------------------------------------------------
...
// -----------------------------------------------------
// Detect relay state changes on the master device
// -----------------------------------------------------
...
// -----------------------------------------------------
// Listen for status changes from the Shelly firmware
// -----------------------------------------------------
...
// -----------------------------------------------------
// Initial state check at script startup
// -----------------------------------------------------
handlePossibleChange();
